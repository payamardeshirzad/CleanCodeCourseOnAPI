...
using System.Linq;
using DesigningTypes.Maybe;
using JetBrains.Annotations;
using NullGuard;

namespace DesigningTypes.NullsResharper {
    public class CustomerProxy {
        [CanBeNull]
        public Customer GetCustomer([AllowNull]Func<Customer, bool> predicate) {
        ...
        public IEnumerable<Customer> GetCustomers(Func<Customer, bool> predicate) {
            var customers = new List<Customer>();
            var result = customers.Where(predicate);
    ...
    public class ProxyConsumer {
        public void ProcessCustomer() {
            ...
            Customer customer = proxy.GetCustomer(null);
            if (customer != null) {
